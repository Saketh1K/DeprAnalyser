    ...
    <div>
        ...
        <div className="lg:grid w-full grid-cols-3 gap-4 min-h-[40vh]">
          <div className="col-span-2">
            <h1 className="mb-3 text-6xl font-bold">
              Welcome to <span className="text-blue-600">DeprAnalyser</span>
            </h1>
            <h3>
      ...
      <footer className="flex items-center justify-center w-full h-24 mt-20 border-t">
        <div className="flex items-center justify-center gap-2">
          Powered by{" "}
          <h4 className="font-bold text-blue-600"><a href='https://github.com/ziqinyeow/depr.ai'>@Saketh</a></h4>
        </div>
      </footer>
    </div>
  );
